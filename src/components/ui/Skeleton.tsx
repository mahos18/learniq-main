    ...
    <div className="card overflow-hidden animate-pulse">
      ...
      <div className="p-4 flex flex-col gap-3">
        ...
        <div className="flex gap-2">
          <div className="h-5 w-16 bg-slate-100 dark:bg-slate-700 rounded-pill" />
          <div className="h-5 w-16 bg-slate-100 dark:bg-slate-700 rounded-pill" />
        </div>
        <div className="h-9 bg-slate-100 dark:bg-slate-700 rounded-input mt-1" />
      </div>
    </div>
  );
}
...
export function SkeletonRow() {
  return (
    <div className="flex items-center gap-3 p-4 border-b border-slate-100 dark:border-slate-700 animate-pulse">
  ...
  return (
    <div className="flex flex-col gap-2 animate-pulse">
      {Array.from({ length: lines }).map((_, i) => (
        <div
          key={i}
          className="h-3.5 bg-slate-100 dark:bg-slate-700 rounded"
